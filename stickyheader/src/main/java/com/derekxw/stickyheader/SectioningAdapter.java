package com.derekxw.stickyheader;
...
public class SectioningAdapter extends RecyclerView.Adapter<SectioningAdapter.ViewHolder> {
	...
	public void notifySectionItemRemoved(int sectionIndex, int itemIndex) {
		if (sections == null) {
			...
			//Log.d(TAG, "notifySectionItemRemoved: adapterPosition is "+section.adapterPosition+" offset is "+offset);
	...
	private void buildSectionIndex() {
        ...
        //Log.d(TAG, "buildSectionIndex: totalNumberOfItems is "+totalNumberOfItems);
	...
	public int getItemCount() {
        ...
        // Log.d(TAG, "getItemCount: "+totalNumberOfItems);
