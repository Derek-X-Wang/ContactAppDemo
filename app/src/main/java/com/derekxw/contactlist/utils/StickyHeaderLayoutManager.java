...
public class StickyHeaderLayoutManager extends LinearLayoutManager {
    ...
    private int computeScrollVectorForPosition2(int targetPosition) {
        updateFirstAdapterPosition();
    ...
    private class SmoothScroller extends LinearSmoothScroller {
        ...
        public PointF computeScrollVectorForPosition(int targetPosition) {
            return new PointF(0, StickyHeaderLayoutManager.this.computeScrollVectorForPosition2(targetPosition));
        }
