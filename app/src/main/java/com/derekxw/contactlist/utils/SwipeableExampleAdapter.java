...
public class SwipeableExampleAdapter
    ...
    private List<Contact> dataArray;
    ...
    public SwipeableExampleAdapter(List<Contact> data) {
        dataArray = data;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final View v = inflater.inflate(R.layout.item_contact_list, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.personFirstNameTextView.setText(dataArray.get(position).getFirstName());
        holder.personFirstNameTextView.setOnClickListener(mItemViewOnClickListener);
        holder.personLastNameTextView.setText(dataArray.get(position).getLastName());
        holder.personLastNameTextView.setOnClickListener(mItemViewOnClickListener);
